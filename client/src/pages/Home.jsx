...
const Home = () => {
  return (
    <div className="w-[80%] my-36  md:mt-16 m-auto flex items-center justify-center h-screen">
      <div className=" w-full grid gap-5  md:grid-cols-2 items-center place-items-center  justify-around">
        <div className="">
          <p className=" Capitalize tracking-wider md:text-left text-center font-semibold text-green-600 text-[2rem]  ">
